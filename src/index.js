...
import ToolboxIcon from "./svg/toolbox-2.svg";
...
export default class ButtonTool {
  ...
  /**
   * Allow to press Enter inside the ButtonTool input
   *
   * @returns {boolean}
   * @public
   */
  ...
  /**
   * @param {ButtonToolData} data - previously saved data
  ...
  /**
   * Select ButtonTool input content by CMD+A
   *
